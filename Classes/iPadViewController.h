...
//The iPadViewController is nearly identical to the iPhoneViewController so all relevant comments are in those header/implementation files.

@interface iPadViewController : UIViewController <UIPickerViewDelegate, UIPickerViewDataSource>{
	//picker related 
	NSArray *spiralType;
	NSArray *colorType;
	UIPickerView *picker;
