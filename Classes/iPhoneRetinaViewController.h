...
//The iPhoneRetinaViewController is nearly identical to the iPhoneVieWController so all relevant comments are in those header/implementation files.

@interface iPhoneRetinaViewController : UIViewController <UIPickerViewDelegate, UIPickerViewDataSource>{
	//picker related 
	NSArray *spiralType;
	NSArray *colorType;
	UIPickerView *picker;
